                  ...
                  Expanded(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        Divider(),
                        //Text("Напротив ТЦ “Муровей” огромная яма в дорожном полотне. dddd derfer  feferf Уже 2 машины попали в ДТП. sd zzzzzzzz zzzz ffff  zzzzzz", maxLines: 3, overflow: TextOverflow.ellipsis, style: TextStyle(color: const Color.fromRGBO(0x8e, 0x8e, 0x8e, 1)),),
                        Text("Напротив ТЦ “Муровей” огромная яма в дорожном полотне. dddd derfer  feferf Уже 2 машины попали в ДТП. sd zzzzzzzz zzzz ffff  zzzzzz", maxLines: 3, overflow: TextOverflow.ellipsis, style: TextStyle(color: const Color.fromRGBO(0x8e, 0x8e, 0x8e, 1)),),
                        Divider(),
                        Text("250 метров от вас", style: TextStyle(color: Theme.of(context).primaryColor),),
                        Divider(),
                      ],
                    ),
                  ),
